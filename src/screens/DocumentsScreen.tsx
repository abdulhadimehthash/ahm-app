...
const styles = StyleSheet.create({
  ...
  docThumb: { width: 64, height: 64, borderRadius: 10, backgroundColor: colors.surfaceLight },
  delAction: {
  ...
  previewImg: { width: 80, height: 80, borderRadius: 10, backgroundColor: colors.surfaceLight },
  previewRemove: {

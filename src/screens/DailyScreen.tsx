...
const styles = StyleSheet.create({
  ...
  briefInput: { backgroundColor:colors.surfaceLight, borderRadius:12, borderWidth:1, borderColor:colors.border, color:colors.white, paddingHorizontal:14, paddingVertical:12, fontSize:15, marginBottom:16 },
  dismissBtn: { backgroundColor:colors.white, borderRadius:12, height:48, alignItems:'center', justifyContent:'center' },
  dismissBtnText: { color:colors.black, fontWeight:'700', fontSize:15 },
  prepBtn: { backgroundColor:colors.card, borderRadius:14, borderWidth:1, borderColor:colors.border, padding:16, marginBottom:20, flexDirection:'row', alignItems:'center' },
  ...
  addBtn: { backgroundColor:colors.surfaceLight, borderRadius:10, borderWidth:1, borderColor:colors.border, paddingVertical:6, paddingHorizontal:12 },
